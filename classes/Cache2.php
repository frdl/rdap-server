 ...
 */
final class Cache2 implements CacheInterface
{
    /**
...
//    const CACHE_TTL = 86400 * 7;
    ...
    public function __construct(string $cache_path = '')
    {
        if ('' === $cache_path) {
            ...
            $cache_path = realpath(dirname(__DIR__)).DIRECTORY_SEPARATOR.'cache'.DIRECTORY_SEPARATOR.'tld';
        }
